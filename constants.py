...
modlist_ssp585 = ['AWI-CM-1-1-MR','BCC-CSM2-MR','CNRM-CM6-1-HR','EC-Earth3-CC','HadGEM3-GC31-LL','GISS-E2-1-G','GFDL-CM4','CMCC-CM2-SR5','CMCC-ESM2','HadGEM3-GC31-MM','NESM3','MPI-ESM1-2-HR','INM-CM4-8','INM-CM5-0','ACCESS-CM2']
...
modset1 = ['CanESM5','CNRM-CM6-1','CNRM-ESM2-1','EC-Earth3-Veg-LR','IPSL-CM6A-LR','MIROC-ES2L','UKESM1-0-LL','MRI-ESM2-0',
           'FGOALS-g3','ACCESS-ESM1-5','MIROC6','MPI-ESM1-2-LR','KACE-1-0-G'] # removed 2 EC-Earth
...
modset3_allscen = ['CanESM5','CNRM-CM6-1','CNRM-ESM2-1','IPSL-CM6A-LR','UKESM1-0-LL','MRI-ESM2-0','FGOALS-g3','ACCESS-ESM1-5','MIROC6',
           'MPI-ESM1-2-LR'] 

modlist_ua = ['CanESM5','CNRM-CM6-1','CNRM-ESM2-1','EC-Earth3-Veg','EC-Earth3-Veg-LR','IPSL-CM6A-LR','MIROC-ES2L',
           'UKESM1-0-LL','MRI-ESM2-0','FGOALS-g3','MIROC6','MPI-ESM1-2-LR','KACE-1-0-G', 'AWI-CM-1-1-MR','BCC-CSM2-MR',
              'CNRM-CM6-1-HR','EC-Earth3-CC','HadGEM3-GC31-LL','GISS-E2-1-G','GFDL-CM4','CMCC-CM2-SR5','CMCC-ESM2',
              'HadGEM3-GC31-MM','NESM3','MPI-ESM1-2-HR','INM-CM4-8','INM-CM5-0','ACCESS-CM2']

modlist_orog = ['CanESM5','CNRM-CM6-1','CNRM-ESM2-1','IPSL-CM6A-LR','MIROC-ES2L','MRI-ESM2-0','FGOALS-g3',
                'ACCESS-ESM1-5','MIROC6','MPI-ESM1-2-LR','AWI-CM-1-1-MR','CNRM-CM6-1-HR','GFDL-CM4',
                'CMCC-CM2-SR5','CMCC-ESM2','MPI-ESM1-2-HR','INM-CM4-8','INM-CM5-0','ACCESS-CM2']

polmods_pos = ['AWI-CM-1-1-MR','BCC-CSM2-MR','CanESM5','EC-Earth3-Veg-LR','FGOALS-g3','GFDL-CM4','HadGEM3-GC31-LL','INM-CM5-0',
               'MIROC-ES2L','MIROC6','MPI-ESM1-2-HR','MPI-ESM1-2-LR','MRI-ESM2-0','NESM3','UKESM1-0-LL']

polmods_neg = ['ACCESS-CM2','ACCESS-ESM1-5','CMCC-CM2-SR5','CMCC-ESM2','CNRM-CM6-1','CNRM-CM6-1-HR','CNRM-ESM2-1','EC-Earth3-CC',
               'EC-Earth3-Veg','GISS-E2-1-G','HadGEM3-GC31-MM','INM-CM4-8','IPSL-CM6A-LR','KACE-1-0-G']

rep_mods = ['CNRM-CM6-1','ACCESS-ESM1-5', 'CanESM5','HadGEM3-GC31-MM','EC-Earth3-Veg-LR']#model representative of the whole ensemble
#scenarios
scenlist= ['historical','ssp126','ssp245','ssp370','ssp585']

#region names
reglist = ['UK','WEU','SEU','EEU','NOR']
reglist2 = ['BI','IP','FR','ME','MD','SC','EA']
